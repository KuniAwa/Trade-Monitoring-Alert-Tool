...
def run_checks() -> dict:
    ...
    # 平日 06:00 JST にサマリーメールを1日1回送信（銘柄ごとに例外を捕捉し1つ失敗しても他は送る）
    try:
